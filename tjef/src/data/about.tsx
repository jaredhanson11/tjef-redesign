...
export const aboutUs: AboutSectionProps[] = [
  {
    ...
    body:
      "For TJEF, our real wealth is our College of Mentors, a group of individuals who have the care and enthusiasm to pass on their knowledge and expertise to John Ernest Fellows who have similar interests or aspirations. They may be college counselors for a lost student. They may have found success in a career field and can share their path with another generation. They may produce an internship for a Fellow. The College of Mentors is the most important step in making dreams into realities.",
